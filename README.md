[![Build Status](https://travis-ci.org/golibri/fetch.svg?branch=master)](https://travis-ci.org/golibri/fetch)
[![GoDoc](https://godoc.org/github.com/golibri/fetch?status.svg)](https://godoc.org/github.com/golibri/fetch)
